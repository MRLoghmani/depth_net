...
def main(argv):
	...
	for opt, arg in opts:
		if opt == '-h':
	 		print 'usage: depth_tree2_0.py -i <source_rootdir> -o <output_rootdir>'
			print 'example: python depth_tree2_0.py -i /home/prusso/Blenders/Francesca -o /home/hades/basefolder'
	   	...
	   	for f in filenames:
			...
			if extension == '.blend':
				fullfilepath = "\""+os.path.abspath(os.path.join(root, f))+"\""		
			   	callstring="blender"+" -b "+fullfilepath+" --python"+" depth_all2_0.py"+ " -- " + fullfilepath + " " + outputdir
