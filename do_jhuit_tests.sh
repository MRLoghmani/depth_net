...
python feature_extractor.py ../JHUIT/JHUIT_normalized/ JHUIT/all_depth.txt $DEPLOY $CAFFE_MODEL $NORM_NAME --center_data --batch-size $BSIZE --layer_name ${layer}
...
SECONDS=0
python -u svm_baseline_parallel.py JHUIT/ $NORM_NAME --splits 1 --split_prefix jhuit_depth_ --classes 49 --mkl_threads 2
...
python -u svm_baseline_parallel.py JHUIT/ $ORIG_NAME --splits 1 --split_prefix jhuit_depth_ --classes 49  --mkl_threads 2
echo "Took $SECONDS seconds"
