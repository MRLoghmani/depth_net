...
#bpy.context.scene.cycles.device= 'GPU' #enabling GPU computing!
...
counter=0 
Epsilon=0.00001
for size in range(1,2): #size regulates the distance of the camera!
    if size==1:
    ...
    n_samples=180*6                                         #-5%..5% of original value
