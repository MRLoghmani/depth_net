...
#python feature_extractor.py /home/hades/Downloads/jhuit_all/JHUIT_normalized/ JHUIT/all_depth.txt $DEPLOY $CAFFE_MODEL $NORM_NAME --center_data --gpu_id 0 --batch-size 1 --layer_name ${layer}
...
#python feature_extractor.py /home/hades/Downloads/jhuit_all/JHUIT/ JHUIT/all_depth.txt $DEPLOY $CAFFE_MODEL $ORIG_NAME --center_data --gpu_id 0 --batch-size 1  --layer_name ${layer}

echo "Running SVM on $NORM_NAME"
SECONDS=0
python -u svm_baseline_parallel.py JHUIT/ $NORM_NAME --splits 1 --split_prefix jhuit_depth_ --classes 49 --mkl_threads 2 --kernel_name jhuit_norm_kernel --saveMargin MarginCaffe1  
